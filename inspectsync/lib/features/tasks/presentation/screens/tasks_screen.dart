...
class TasksScreen extends StatelessWidget {
                          ...
                          ...tasks.map((Task task) {
                            ...
                            return Padding(
                              ...
                              child: TaskCard(
                                title: task.title,
                                subtitle:
                                    "ID: #OPS-${task.id.substring(0, 8).toUpperCase()}",
                                location: (task.lat != null && task.lng != null)
                                    ? "COORD: ${task.lat!.toStringAsFixed(4)}, ${task.lng!.toStringAsFixed(4)}"
                                    : "LOCATION PENDING",
                                time:
                                    "${task.updatedAt.hour}:${task.updatedAt.minute.toString().padLeft(2, '0')}",
  ...
  Widget _buildTacticalStatusCard(
